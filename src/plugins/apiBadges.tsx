...
export default definePlugin({
    ...
    patches: [
        /* Patch the badges array */
        {
            ...
            replacement: {
                ...
                replace: (_, m, badgeArray) => `&&${m} return bluecord.Api.Badges.inject(${badgeArray}, arguments[0]);}`,
            }
        },
    ...
    async start() {
        bluecord.Api.Badges.addBadge(ContributorBadge);
                            ...
                            <Modals.ModalRoot {...props}>
                                ...
                                <Modals.ModalContent>
                                    ...
                                    <div style={{ padding: "1em" }}>
                                        <Forms.FormText>
                                            This Badge is a special perk for bluecord Donors
                                        </Forms.FormText>
                                        <Forms.FormText className={Margins.marginTop20}>
                                            Please consider supporting the development of bluecord by becoming a donor. It would mean a lot!!
                                        </Forms.FormText>
                                    </div>
                                </Modals.ModalContent>
                                <Modals.ModalFooter>
