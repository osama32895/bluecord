...
export default definePlugin({
    ...
    patches: [{
        ...
        replacement: [{
            ...
            replace: (_, mod) => {
                ...
                const renderIgnoreActivitiesToggle = ([
                    ...
                    { match: /((.)=this\.props\.game)(.{1,70})=.{1,2}overlay/, replace: "$1,IgnoreActivities_gameProps=$2$3=bluecord.Plugins.plugins.IgnoreActivities.isActivityEnabled(IgnoreActivities_gameProps)" },
                    /** Change the handler for clicking the button */
                    { match: /.\.handleOverlayToggle/, replace: "() => bluecord.Plugins.plugins.IgnoreActivities.handleActivityToggle(IgnoreActivities_gameProps)" },
        ...
        replacement: {
            ...
            replace: "$1$2=$2.filter(bluecord.Plugins.plugins.IgnoreActivities.isActivityEnabled);"
        }
    }],
