                        ...
                        embeds: [
                            {
                                ...
                                color: 0xFF9900,
                                footer: { text: `ðŸ‘ ${definition.thumbs_up.toString()} | ðŸ‘Ž ${definition.thumbs_down.toString()} | Uploaded by ${definition.author}`, icon_url: "https://www.urbandictionary.com/favicon.ico" },
